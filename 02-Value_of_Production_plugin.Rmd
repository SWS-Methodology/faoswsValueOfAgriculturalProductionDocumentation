...
![Gross Production Value Plugin dataflow ](./images/data_flow.png){ width=150% }
<br>
...
![Gross Production Value Plugin Input data flow](./images/input_data_flow.png){ width=150% }
...
![Running Plugin](./images/SWS_first2.png){#screenuno scale=110% }
  ...
  5. Select the parameters: base year, level of aggregation and Data sources. The user can also choose the execution method for the plugin, if many elements and long time-span are selected, it is suggested to choose the "send me an email" option since it can take a few hours to run entirely. 
